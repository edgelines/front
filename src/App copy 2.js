    ...
    return (
        <div className="App">
            <Navbar bg="light" variant="dark">
                <Container>
                    <Navbar.Brand href="/">HIJO NAM</Navbar.Brand>
                    <Nav className="me-auto">
                        <Nav.Link onClick={() => { navigate('/') }}>BIO</Nav.Link>
                        <Nav.Link onClick={() => { navigate('/detail') }}>ARTWORKS</Nav.Link>
                        <Nav.Link onClick={() => { navigate('/about') }}>EXHIBITION</Nav.Link>
                        <Nav.Link onClick={() => { navigate('/about/member') }}>Member</Nav.Link>
                        <Nav.Link onClick={() => { navigate('/about/location') }}>Location</Nav.Link>
                        <Nav.Link onClick={() => { navigate('/cart') }}>PORTFOLIO</Nav.Link>
                    </Nav>
                </Container>
            </Navbar>
